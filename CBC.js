...
function ETripleDes(Plain_txt, BigKey, IV) {
...
function DTripleDes(Cipher_txt, BigKey, IV) {
...
document.addEventListener("DOMContentLoaded", function () {
  document
    ...
    .addEventListener("click", function (event) {
      ...
      if (!isHexadecimal(BigKey) || !isHexadecimal(IV)) {
        isvalid = false;
      ...
      $("#Result").append(
        "<div>Mã IV: " + IV + " ( Hex ) " + Hex_to_Bin(IV) + "</div>"
      );
      ETripleDes(input, BigKey, IV);
    });
  document
